...
<cfloop query="#theTeams#">
		...
		<cfloop query="#theopponents#">
			...
			***************************************************************************************************<br>
			...
			<cfset opAdjInt    = pbpStats.pIntRt      + (pbpStats.pIntRt     * (oppbta.dpIntRt))>
			...
			SackRt3rdAndLong,BadResult3rdAndLongPass,IntRt2ndAnd3rdDown) values(#theopponents.week#,'#theTeams.Team#','#theopponents.opp#','O',#oAdjSR#,#oAdjBigPass#,
			#oAdjRun#,#oAdjBig#,#op1and2#,#op3rd#,#oToGo3rd#,#oskrt#,#oBadResult#,#opAdjInt#)
			</cfquery>		
				
				
			<cfquery datasource="sysstats3" name="Teams">
			INSERT INTO AdjPBPSuccessRates(Week,Team,Opp,OffDef,OverallSuccRt,BigPlayPassRt,RunSuccessRt,BigPlayRt,SuccRt1and2Down,SuccRt3rdDown,AvgToGo3rdDown,
			SackRt3rdAndLong,BadResult3rdAndLongPass,IntRt2ndAnd3rdDown) values(#theopponents.week#,'#theopponents.opp#','#theTeams.Team#','D',#oAdjSR#,#oAdjBigPass#,
			#oAdjRun#,#oAdjBig#,#op1and2#,#op3rd#,#oToGo3rd#,#oskrt#,#oBadResult#,#opAdjInt#)
			</cfquery>		
...
<cfargument name="team" type="String"  required="no" />
		...
		<cfquery datasource="sysstats3" name="bta">
			SELECT pbp.OverallSuccRt/100 as pOverall, pbp.RunSuccessRt/100 as pRun, pbp.BigPlayRt/100 as pBig, pbp.SuccRt1and2Down as p1and2, pbp.SuccRt3rdDown/100 as p3rd, pbp.AvgToGo3rdDown / 100 as pToGo3rd,
				   pbp.BigPlayPassRt/100 as pBigPass, pbp.SackRt3rdAndLong / 100 as pskrt, pbp.BadResult3rdAndLongPass/100 as pBadResult,pbp.IntRt2ndAnd3rdDown as pIntRt,
				   ...
				   dpbp.BigPlayPassRt/100 as dpBigPass, dpbp.SackRt3rdAndLong / 100 as dpskrt, dpbp.BadResult3rdAndLongPass/100 as dpBadResult,dpbp.IntRt2ndAnd3rdDown as dpIntRt
...
<cfargument name="team" type="String"  required="no" />
		...
		<cfquery datasource="sysstats3" name="pbpsr">
			SELECT pbp.OverallSuccRt as pOverall, pbp.RunSuccessRt as pRun, pbp.BigPlayRt as pBig, pbp.SuccRt1and2Down as p1and2, pbp.SuccRt3rdDown as p3rd, pbp.AvgToGo3rdDown as pToGo3rd,
				   pbp.BigPlayPassRt as pBigPass, pbp.SackRt3rdAndLong as pskrt, pbp.BadResult3rdAndLongPass as pBadResult, pbp.IntRt2ndAnd3rdDown as pIntRt,
				   ...
				   dpbp.BigPlayPassRt as dpBigPass, dpbp.SackRt3rdAndLong as dpskrt, dpbp.BadResult3rdAndLongPass as dpBadResult, dpbp.IntRt2ndAnd3rdDown as dpIntRt
