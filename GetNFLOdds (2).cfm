		...
		Delete from NBASchedule where Gametime='#GetDay.Gametime#'
		</cfquery>
		...
		<cfoutput>
			...
			<cfhttp url="https://www.covers.com/sports/nba/matchups?selectedDate=2020-12-26" method="GET">
			<cfhttp url="https://www.covers.com/sports/nba/matchups" method="GET">			
			</cfhttp> 
		</cfoutput>
	...
	<cfloop index="ii" from="1" to="#i#">
		...
		<cfoutput>
		======================================>'#GetDay.Gametime#','#favis#','#Ha#',#xspd#,'#undis#',#xou#<p>
		</cfoutput>
			...
			<cfif 1 is 1>
				...
				<cfquery datasource="nba" name="addit">
				INSERT INTO NBASchedule(Gametime,FAV,HA,SPD,UND,OU) values ('#GetDay.Gametime#','#favis#','#Ha#',#xspd#,'#undis#',#xou#)
				</cfquery>
