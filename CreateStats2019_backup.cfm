...
<cfargument name="theWeek"    type="Numeric"  required="yes" />
	...
	<cfset diff5 = 0>
		...
		Select PowerAdjForRushPassBTA,  PowerRat2022, PRUltimate, FinalPowerRat, PR2022 as PowerPts from betterthanavg
		where Team='#vfav#'
		</cfquery>
		...
		<cfset vFavPowerRating     = #GetFavPR.PowerPts#>	
		...
		<cfset vUndPowerRating     = #GetUndPR.PowerPts#>	
...
<p>		
	...
	<cfquery datasource="sysstats3" name="UpdIt">	
	UPDATE Teams
	SET SpotLevel1Play = '#UndLevel1#',
		SpotLevel2Play = '#UndLevel2#',
	...
	<cfquery datasource="sysstats3" name="UpdIt">	
	UPDATE Teams
	SET SpotLevel1Play = '#FavLevel1#',
		SpotLevel2Play = '#FavLevel2#',
